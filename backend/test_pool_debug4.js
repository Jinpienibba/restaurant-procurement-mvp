...
console.log('DB_PASSWORD.trim():', process.env.DB_PASSWORD?.trim());
console.log('DB_PASSWORD.trim() truthy:', !!process.env.DB_PASSWORD?.trim());
...
console.log('poolConfig:', JSON.stringify(poolConfig, null, 2));
console.log('poolConfig.password:', poolConfig.password);
